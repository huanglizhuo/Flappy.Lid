...
我们偷偷摸摸地读取了藏在转轴里的角度传感器（用了点不太见光的 IOKit 技术 🧙‍♂️），只要一开一合屏幕，就能触发各种操作。
...
*   **技术先驱**：特别感谢 [LidAngleSensor](https://github.com/samhenrigold/LidAngleSensor) 的作者 **Sam Henri Gold**，是他最早挖出了这个隐藏传感器。
*   **灵感来源**：看到推特上 [@rebane2001](https://x.com/rebane2001/status/2007198231479103611) 问：“我能不能靠拍折叠屏来让角色跳起来？”——我们就想：那不如直接拍 MacBook 吧！
...
3.  **只支持 Apple Silicon**：
    ...
    *   Intel 机型不行——它们用的传感器不一样，而且据说太烫，传感器都快烤熟了（大概）。
    *   另外，我们用了苹果没公开的接口，哪天系统更新把它封了，这软件就废了。趁现在还能用，赶紧玩！
